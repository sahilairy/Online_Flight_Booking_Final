...
namespace Online_Flight_Booking_Final.Controllers
{
    ...
    public class PassengersController : Controller
    {
        ...
        public PassengersController(Online_Flight_BookingDataContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,Name,Mobile")] Passenger passenger)
        {
            if (id != passenger.Id)
            {
                return NotFound();
